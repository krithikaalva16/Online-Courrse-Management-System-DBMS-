...
if (count($_POST)>0) {
$sql="UPDATE student_result set totalmarks='".$_POST['totalmarks']."'
,gainmarks='".$_POST['gainmarks']."',percentage='".$_POST['percentage']."' WHERE sid='".$_POST['sid']."' 
AND assessment='".$_POST['assessment']."' AND course='".$_POST['course']."'";
...
$recod= "SELECT * from student_result WHERE sid ='".$_GET['sid']."' 
AND assessment ='".$_GET['assessment']."' AND course ='".$_GET['course']."'";
          ...
          <div class="modal-body" style="background-image: linear-gradient(#000066,#ffffff);">
            ...
            <section class="logsection">
               <div class="logform">
                  ...
                  <input type="text" name="sid" value="<?php echo $row['sid']; ?>" readonly><br><br>
