	...
	<div class="row">
		<div class="col-md-4 offset-md-4  from-div">
				<div class="form-group">
					<button  type="submit" class="btn btn-primary btn-block btn-lg" data-toggle="modal" data-target="#myModal">STUDENT</button>
			      ...
			      <form action="user_signup.php" method="POST" class="form" enctype="multipart/form-data" onsubmit="return validation()">
				      <div class="row">
				        <div class="col-sm-6">
				          ...
				          <input type="text" id="sid" name ="sid" pattern="[1-4][A-Z][A-Z]\d\d(CS|IS|EC|CV|ME)\d\d\d" placeholder="enter USN" required >
						<br><br>
				        ...
				        <div class="col-sm-6">
				          ...
				          <input type="password" id="password" name ="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"  placeholder="enter password" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required> <br><br>

				        	<label for="contact">Contact</label>
				          <span id="Contact" class="required"></span><br>
				          <input type = "text" pattern="[7-9]{1}[0-9]{9}" id="contact" name="contact" placeholder = "enter contact" ><br><br>
	        ...
	        <div class="modal-body" style="background-image: linear-gradient(#000066,#ffffff);">
	          ...
	          <section class="logsection">
	             <div class="logform">
	                ...
	                <span id="sid" class="require"></span><br>
	                <input type = "text" id  ="sid" name="sid" placeholder = "Enter USN" required="value"><br><br>
	        ...
	        <div class="modal-body" style="background-image: linear-gradient(#000066,#ffffff);">
	          ...
	          <section class="logsection">
	             <div class="logform">
	                ...
	                <label for="sid"><b>SID</b></label>
	                <span id="sid" class="require"></span><br>
	                <input type = "text" id  ="sid" name="sid" placeholder = "Enter Sid" required="value"><br><br>
	  ...
	  <div class="modal fade" id="AdminModal" role="dialog">
	    <div class="modal-dialog">
	      ...
	      <div class="modal-content">
	        ...
	        <div class="modal-footer" style="background: #1f1f2e;">
	          <!-- <button type="button" class="btn btn-primary" data-dismiss="modal" data-toggle="modal" data-target="#myModal">Student</button> -->
	        </div>
	      </div>
