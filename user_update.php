		...
		<form action="" method="POST" class="form" enctype="multipart/form-data" onsubmit="return validation()">
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <input type="text" id="fname" name ="fname" placeholder="enter first name" required value="<?php echo $row["fname"];?>"><br><br>
                  ...
                  <input type = "date" id="dob"  name="dob" placeholder = "enter date of birth"  required value="<?php echo $row["dob"];?>"><br><br>
                ...
                <div class="col-sm-6">
                  ...
                  <input type="password" id="password" name ="password" placeholder="enter password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required value="<?php echo $row["password"];?>"><br><br>

                  <label for="contact">Contact</label>
                  <span id="Contact" class="required"></span><br>
                  <input type = "text" id="contact" name="contact" placeholder = "enter contact" pattern="[7-9]{1}[0-9]{9}" required value="<?php echo $row["contact"];?>"><br><br>
