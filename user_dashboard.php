...
if($_SESSION["sid"]==true)
{
  $sid = $_SESSION["sid"];
  $result = mysqli_query($conn,"SELECT sid, fname FROM `student` WHERE sid = '$sid' ");
        ...
        <div class="col-12 col-sm-3 col-xl-2 px-sm-2 px-0 bg-dark d-flex sticky-top">
            <div class="d-flex flex-sm-column flex-row flex-grow-1 align-items-center align-items-sm-start px-3 pt-2 text-white">
                ...
                <ul class="nav nav-pills flex-sm-column flex-row flex-nowrap flex-shrink-1 flex-sm-grow-0 flex-grow-1 mb-sm-auto mb-0 justify-content-center align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        <a href="user_update.php?sid=<?php echo $row['sid']; ?>" class="nav-link px-sm-0 px-2">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdown">
                            <li><a class="dropdown-item" href="student_manage_course.php?sid=<?php echo $row['sid']; ?>">Add/Manage Courses</a></li>
                        </ul>
                ...
                <div class="dropdown py-sm-4 mt-sm-auto ms-auto ms-sm-0 flex-shrink-1">
                    ...
                    <img src="user_icon.png" alt="" width="38" height="38" class="rounded-circle">
                        <span class="d-none d-sm-inline mx-1"><?php echo $row["sid"];?></span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
                        <li><a class="dropdown-item" href="user_update.php?sid=<?php echo $row['sid']; ?>">Profile</a></li>
                        <li>
                 ...
                 <!-- Icon Cards-->
                  <div class="row">
                    <?php
                        ...
                        $record="SELECT * FROM student_course WHERE sid = '$sid'";
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                      <div class="card text-white bg-warning o-hidden h-100">
                        ...
                        <a class="card-footer text-white clearfix small z-1 text-decoration-none" href="student_result_show.php?sid=<?php echo $row['sid']; ?>&course=<?php echo $row['course']; ?>">
