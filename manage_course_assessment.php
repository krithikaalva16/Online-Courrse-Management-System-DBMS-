<?php
  ...
  $user="SELECT * FROM quiz WHERE assessment='$assessment'";
  $query = mysqli_query($conn, $user);
    ...
    if(mysqli_num_rows($query) > 0 ) { //check if there is already an entry for that username
      ...
      //echo "chutti";
      $sql="INSERT INTO quiz(`assessment`) VALUES ('$assessment')";
  ...
  <!----------------------------------- Modal for Admin Add Courses --------------------------------------->
               ...
               <div class="logform">
                  ...
                  <?php 
                       ...
                       if(isset($_GET['exists']))
                       {
                           ...
                           echo '<script>alert("This Assessment name already exists.")</script>';
                       }
                        ...
                        if(isset($_GET['No_inserted']))
                        {
                            ...
                            echo '<script>alert("Assessment not added please try Again.")</script>';
                        }
                  ...
                  <label for=""><b>New Assessment</b></label>
    ...
    <?php 
                       ...
                       if(isset($_GET['updated']))
                       {
                           ...
                           echo '<script>alert("Updated assessment Successfully")</script>';
                       }

                        if(isset($_GET['no_updated']))
                        {
                                    
                            echo '<script>alert("Assessment not Updated please try Again")</script>';
                        }
