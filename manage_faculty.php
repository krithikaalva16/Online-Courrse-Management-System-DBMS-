...
<body>
  ...
  <button type="button" onclick="home();" class="btn btn-info">Back</button>  
              <div style="font-size:30px; text-align:center;";>Add/Manage Faculty</div>
            </div>
            <div class="card-body">
            <div>  
            <a class="btn btn-primary mb-3" href="" style="" data-bs-toggle="modal" data-bs-target="#Add_Faculty_Modal">Add Members</a>
            </div>  
  ...
  <!----------------------------------- Modal for Admin Add Courses --------------------------------------->
          ...
          <div class="modal-body" style="background-image: linear-gradient(#000066,#ffffff);">
            ...
            <section class="logsection">
               <div class="logform">
                  ...
                  <label for=""><b>Faculty Id</b></label>
                  <span id="" class="require"></span><br>
                  <input type = "text" id  ="" name="f_id" pattern="\d\d\d"  placeholder = "Enter Id" required="value"><br><br>
                  <label for=""><b>FName</b></label>
                  <span id="" class="require"></span><br>
                  <input type = "text" id  ="" name="name" placeholder = "Enter Name" required="value"><br><br>
                  <label for=""><b>Designation </b></label>
                  <span id=""  class="require"></span><br>
                  <select style="width:69%"  name="designation">
    <option value="Lecturer">Lecturer</option>
    <option value="Head of Dept">HOD</option>
    ...
    <option value=""></option>
                  ...
                  <span id="" class="require"></span><br>
                  <input type = "password" id  ="" name="password" placeholder = "Enter Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required="value"><br><br>
